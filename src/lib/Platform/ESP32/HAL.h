...
typedef spi_host_device_t HALSPIBus;
typedef uart_port_t HALUARTBus;
...
#define GPIO_IN                 0
#define GPIO_OUT                1
#define GPIO_FUNC_SPI           0  // No-op here: SPI pins are configured in SPIInit.
#define GPIO_FUNC_PWM           0  // No-op here: PWM is configured through LEDC.
#define GPIO_FUNC_UART          0  // No-op here: UART pins are configured in UARTInit.
#define PWM_CHAN_B              1
